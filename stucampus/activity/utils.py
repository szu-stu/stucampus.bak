...
def fill_in_table(message_tbl, cls):
    ...
    for msg in to_be_published:
        if msg.time == MORNING:
            message_tbl['day_tr'][msg.date.weekday()]['morning'].append(msg)
            message_tbl['morning'][msg.date.weekday()].append(msg)
        else:
            message_tbl['day_tr'][msg.date.weekday()]['afternoon'].append(msg)
            message_tbl['afternoon'][msg.date.weekday()].append(msg)
