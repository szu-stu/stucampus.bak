...
class Resource(models.Model):
    ...
    team_members1_name = models.CharField(max_length=None)
    team_members1_id = models.CharField(max_length=10)
    team_members2_name = models.CharField(max_length=None)
    team_members2_id = models.CharField(max_length=10)
    team_members3_name = models.CharField(max_length=None)
    team_members3_id = models.CharField(max_length=10)
    team_members4_name = models.CharField(max_length=None)
    team_members4_id = models.CharField(max_length=10)
    team_members5_name = models.CharField(max_length=None)
    team_members5_id = models.CharField(max_length=10)
